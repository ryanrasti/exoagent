...
export interface IExoArray<T = unknown> {
...
export interface IExoNumber {
  toString: (radix?: number) => string
}

export interface IExoBoolean {
  valueOf: () => boolean
  toString: () => string
}

export interface IExoDate {
  getTime: () => number
  getFullYear: () => number
  getMonth: () => number
  getDate: () => number
